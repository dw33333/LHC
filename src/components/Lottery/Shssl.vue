...
export default {
  ...
  methods:{
    ...
    getfuArry () {
      ...
      that.$http.get('api/lottery-v1/shssl/odds/').then(function(res){
    ...
    getarr () {
      let that = this;
      that.$http.get('/api/lottery-v1/shssl/opentime/').then(function(res){
...
<style scoped>
.li_1 i{
  background: -webkit-gradient(linear, left top, left bottom, from(#339999), to(#F0EDE7));
  background: -webkit-linear-gradient(#339999, #F0EDE7);
  background: linear-gradient(#339999, #F0EDE7);
}
#result{
  background: -webkit-gradient(linear, left top, left bottom, from(#339999), to(#F0EDE7));
  background: -webkit-linear-gradient(#339999, #F0EDE7);
