  ...
  <div class="box">
      <div class="content">
        ...
        <div class="table1" v-show="showtihuan">
          <div v-for="(item,index) in forLength.length" class="lottery_o_box" :key="item.id">
...
export default {
  ...
  methods:{
    ...
    async getfuArry () {
      ...
      that.$http.get('api/lottery-v1/ahk3/odds/').then(function(res){
    ...
    getarr () {
      let that = this;
      that.$http.get('/api/lottery-v1/ahk3/opentime/').then(function(res){
